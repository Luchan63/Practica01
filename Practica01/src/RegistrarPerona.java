...
public class RegistrarPerona
{
    double imc;
    ArrayList <Persona> lisPersonas; // declaramos nuestra lista

    public RegistrarPerona()
    {
        //inicializamos la lista
        lisPersonas = new ArrayList<>();
    }

    public void registrarPersonas(Persona p)
    {
    ...
    public String calcularIMC(double peso, double altura)
    {
        ...
        return String.format("IMC: %.2f%n su indice indica que tiene un peso: %s",imc,msj); // lo retomamos con String.format para poder elegir el formato y solo coger 2 decimal
    }
